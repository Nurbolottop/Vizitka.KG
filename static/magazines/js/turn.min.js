...
$(document).ready(function() {
    var book = $('#flipbook'); // Предполагается, что ваша книга имеет id="book"
    
    // Обработчик событий колеса мыши для перелистывания
    book.bind('wheel', function(e) {
      e.preventDefault(); // Предотвращаем стандартное поведение прокрутки
  
      var delta = e.originalEvent.deltaY;
      if(delta > 0){
        // Прокрутка вниз - перелистываем на следующую страницу
        $(this).turn('next');
      }else{
        // Прокрутка вверх - перелистываем на предыдущую страницу
        $(this).turn('previous');
      }
